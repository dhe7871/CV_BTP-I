...
psi0 = [pi/4, -pi/4, 3*pi/4, -3*pi/4];        %initial heading angle of the UAV (can change)
...
for e = 1:Ne
    leg(e+2) = "\psi_0 = " + round(psi0(e)*180/pi) + "^o";
...
xlabel("x [m]");
ylabel("y [m]");
title("PLOS algorithm for line following (variation \psi)");
